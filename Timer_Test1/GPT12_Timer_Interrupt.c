...
#define RELOAD_VALUE_10msec                9765u            /* Reload value to have an interrupt each 500ms         */
#define LED                         &MODULE_P00, 5          /* LED which toggles in the Interrupt Service Routine   */
#define Test_pin1                   &MODULE_P00, 2
/*********************************************************************************************************************/
...
void initGpt12Timer(void)
{
    ...
    IfxGpt12_T3_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_10msec);                        /* Set T3 start value           */
...
void interruptGpt12(void)
{
    ...
    if(timer3_cnt==2000)
    {
        IfxGpt12_T3_run(&MODULE_GPT120, IfxGpt12_TimerRun_stop);                       /* Stop the timer              */
